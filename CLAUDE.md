...
- TypeScript 5.4 / Node.js 20 (ESM) in `ai/`; JavaScript ESM (Vite 8 + Phaser 3.90) in `game/` + `openai ^4.x`, `chalk ^5.x`, Node built-ins (`http`, `fs`, `path`, `fetch`); `phaser ^3.90`, `vite ^8` (006-dungeon-debug-leveling)
